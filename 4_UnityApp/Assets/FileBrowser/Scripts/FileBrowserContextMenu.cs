...
#pragma warning restore 0649
		...
		{
            FileBrowser.Skin.ApplyTo(selectAllButton);
            FileBrowser.Skin.ApplyTo(deselectAllButton);
            FileBrowser.Skin.ApplyTo(createFolderButton);
            FileBrowser.Skin.ApplyTo(deleteButton);
            FileBrowser.Skin.ApplyTo(renameButton);
